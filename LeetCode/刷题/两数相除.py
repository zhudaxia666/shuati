...
用除数不断地乘上2做数字的翻倍的操作直到超过被除数后 ，然后对剩下的余数做类似操作 ，直至得到的余数小于被除数或者为0
回到例子来说 23/3  :
a .  3翻倍：3•2=6    余数17
b.   再次翻倍 6•2=12 ;   余数11
c.   再次翻倍12•2=24  此时24 大于23 了 返回b 此时3×2^2 余数为11 加权值p=2
...
def divide(self, dividend, divisor):
        ...
        :rtype: int
        """
        sign = -1 if (divisor>0)^(dividend>0)  else 1#判断是符号位
